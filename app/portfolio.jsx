...
const SKILLS = {
  ...
  "Data & Analytics": ["Pandas", "NumPy", "SQL", "Tableau", "Power BI", "Excel", "Matplot lib"],
...
const ARTICLES = [
  // Example:
  // { id: 1, title: "Why RAG beats fine-tuning for most enterprise use cases", date: "2024-03", platform: "LinkedIn", url: "#", excerpt: "..." }
];
...
// Navbar
// ============================================================
const NAV_ITEMS = ["About", "Skills", "Projects", "Dashboard", "Writing", "Contact"];
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      if (!deleting) {
        ...
        i++;
        if (i === role.length) { deleting = true; setTimeout(() => { }, 1500); }
      } else {
        setTyped(role.slice(0, i - 1));
        i--;
        if (i === 0) { deleting = false; setRoleIdx(r => (r + 1) % roles.length); }
      }
    }, deleting ? 40 : 80);
  ...
  return (
    <section style={{
      ...
      <p style={{
        ...
        color: darkMode ? "#94a3b8" : "#64748b",
        maxWidth: 620, margin: "0 0 40px", lineHeight: 1.65,
      ...
      {/* Social links */}
      <div style={{ display: "flex", gap: 20, marginTop: 48, animation: "fadeInUp 0.7s ease 0.5s both" }}>
        {[
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, alignItems: "start" }}>
          ...
          <div>
            <div style={{
              ...
              <p style={{ margin: 0, fontSize: 17, lineHeight: 1.75, color: darkMode ? "#cbd5e1" : "#334155" }}>
                {CONFIG.bio}
              </p>
            </div>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          {project.demo && (
            <a href={project.demo} target="_blank" rel="noreferrer" style={{
              ...
              border: `1px solid ${darkMode ? "rgba(255,255,255,0.1)" : "rgba(0,0,0,0.1)"}`,
              color: darkMode ? "#94a3b8" : "#64748b", textDecoration: "none", fontSize: 14,
  ...
  return (
    <Section id="contact" style={{ padding: "100px 24px" }}>
      <div style={{ maxWidth: 700, margin: "0 auto" }}>
        <SectionHeader label="Contact" title="Let's Work Together" subtitle="Open to internships, graduate roles, and interesting side projects. Let's talk." darkMode={darkMode} />
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 16, marginBottom: 32, flexWrap: "wrap" }}>
            {[
              ...
              { icon: "💼", label: "LinkedIn", value: "Connect", href: CONFIG.linkedin },
              { icon: "⌥", label: "GitHub", value: "Follow", href: CONFIG.github },
              ...
              >
                ...
                <div>
                  <div style={{ fontSize: 11, color: darkMode ? "#475569" : "#94a3b8", fontFamily: "'JetBrains Mono', monospace" }}>{label}</div>
                  <div style={{ fontSize: 13, fontWeight: 500, color: darkMode ? "#cbd5e1" : "#475569" }}>{value}</div>
                </div>
              </a>
            ))}
          </div>

          <div style={{ height: 1, background: darkMode ? "rgba(255,255,255,0.07)" : "rgba(0,0,0,0.07)", marginBottom: 28 }} />

          {/* Form */}
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
            <div>
              <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: darkMode ? "#64748b" : "#94a3b8", fontFamily: "'JetBrains Mono', monospace", marginBottom: 6, textTransform: "uppercase", letterSpacing: "0.07em" }}>Name</label>
            ...
            <div>
              <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: darkMode ? "#64748b" : "#94a3b8", fontFamily: "'JetBrains Mono', monospace", marginBottom: 6, textTransform: "uppercase", letterSpacing: "0.07em" }}>Email</label>
              <input style={inputStyle} placeholder="your@email.com" type="email" value={form.email} onChange={e => setForm(f => ({ ...f, email: e.target.value }))}
                onFocus={e => e.target.style.borderColor = "#7c3aed"}
                onBlur={e => e.target.style.borderColor = darkMode ? "rgba(255,255,255,0.12)" : "rgba(0,0,0,0.1)"} />
            </div>
          </div>
          <div style={{ marginBottom: 24 }}>
            ...
            <textarea style={{ ...inputStyle, resize: "vertical", minHeight: 120 }} placeholder="Hi, I'm a recruiter at..." value={form.message} onChange={e => setForm(f => ({ ...f, message: e.target.value }))}
              onFocus={e => e.target.style.borderColor = "#7c3aed"}
              onBlur={e => e.target.style.borderColor = darkMode ? "rgba(255,255,255,0.12)" : "rgba(0,0,0,0.1)"} />
          </div>
          <button onClick={handleSubmit} style={{
            width: "100%", padding: "14px", borderRadius: 10, border: "none", cursor: "pointer",
            background: sent ? "linear-gradient(135deg, #10b981, #059669)" : "linear-gradient(135deg, #7c3aed, #06b6d4)",
            color: "#fff", fontSize: 15, fontWeight: 700, fontFamily: "inherit",
            boxShadow: `0 0 30px ${sent ? "rgba(16,185,129,0.4)" : "rgba(124,58,237,0.35)"}`,
            transition: "all 0.3s",
          }}>
